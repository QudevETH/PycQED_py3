...
class SHF_AcquisitionDevice(ZI_AcquisitionDevice):
    ...
    def store_awg_source_string(self, channel, awg_str):
        ...
        channel via set_awg_program. The source strings get stored in the
        dict self._awg_source_strings.

        Args:
             channel: the QA channel object for which the AWG was programmed
