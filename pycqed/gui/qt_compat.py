...
if QtWidgets.__package__ in ['PyQt6']:
    ...
    # its instance. Some code creates the instance disregard the updated QtWidgets.QApplication
    if QtWidgets.QApplication.instance() is None:

        # It is important to assign this so some variable.
        # Without it the instance() method wouldn't have a pointer to the
        # instance and return None on the next call
        app = QtWidgets.QApplication(sys.argv)

    # If there is already and instance of QApplication, and it is not an
    ...
    # method to it.
        ...
        QtWidgets.QApplication.instance().exec_ = QtWidgets.QApplication.instance().exec
