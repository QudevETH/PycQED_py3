    ...
    def test_with_single_AWG(self):
        ...
        for i in range(4):
            self.station.pulsar.define_channel(
                id="ch{}".format(i + 1), name="ch{}".format(i + 1)
            )
            self.station.pulsar.define_channel(
                id="ch{}_m1".format(i + 1), name="ch{}_marker1".format(i + 1)
            )
            self.station.pulsar.define_channel(
                id="ch{}_m2".format(i + 1), name="ch{}_marker2".format(i + 1)
            )
    ...
    def test_with_multiple_AWGs(self):
        ...
        for i in range(1, 3):
            for j in range(1, 5):
                ...
                self.station.pulsar.set("AWG{}_ch{}_marker1_amp".format(i, j), 2.0)
                self.station.pulsar.set("AWG{}_ch{}_marker2_amp".format(i, j), 2.0)
