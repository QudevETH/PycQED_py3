...
class Test_CZ_1QPhaseCal_Analysis(unittest.TestCase):
    ...
    def test_zero_phase_diff_intersect(self):
        a = ma.CZ_1QPhaseCal_Analysis(
            t_start="20171126_180251", options_dict={"ch_idx": 1}
        )
        self.assertAlmostEqual(a.get_zero_phase_diff_intersect(), 0.058, places=3)

        a = ma.CZ_1QPhaseCal_Analysis(
            t_start="20171126_181327", options_dict={"ch_idx": 0}
        )
        self.assertAlmostEqual(a.get_zero_phase_diff_intersect(), 0.1218, places=3)
